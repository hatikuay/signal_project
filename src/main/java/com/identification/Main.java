...
public class Main {
    public static void main(String[] args) {
        ...
        PatientRecord record1 = new PatientRecord("patient1", "John Doe", new Date(), Arrays.asList("Allergy: Penicillin", "Asthma"));
        PatientRecord record2 = new PatientRecord("patient2", "Jane Smith", new Date(), Arrays.asList("Diabetes", "Hypertension"));
